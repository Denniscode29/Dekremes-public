...
function Navbar({ title }) {
  ...
  // route dengan background solid (ditambah /profile)
  const solidBgRoutes = ["/tentang", "/blog", "/menu", "/kontak", "/testimoni", "/profile"];

  // auth state - dengan subscribe ke perubahan state
    ...
    >
      <div className="flex justify-between items-center py-4 px-6 md:px-12">
        ...
        <div className="flex items-center space-x-4 relative" ref={menuRef}>
          ...
          {/* Avatar selalu ada - akan otomatis update ketika user berubah */}
